...
Service.prototype.getCachedOutput = function getCachedOutput(key) {
  return this.cache.get(key);
};

Service.prototype.callPending = function callPending(key, err, output) {
...
Service.prototype.call = function call(data, key, cb) {
